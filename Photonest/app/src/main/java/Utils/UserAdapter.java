...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ImageViewHolder> {
        ...
        holder.btn_follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (holder.btn_follow.getText().toString().equals("follow")) {
                    FirebaseDatabase.getInstance().getReference().child("followers").child(user.getId())
                            .child(firebaseUser.getUid()).child("user_id").setValue(firebaseUser.getUid());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(View itemView) {
            ...
            btn_follow = itemView.findViewById(R.id.btn_follow_useritem);
        }
    }
    ...
    private void isFollowing(final String userid, final Button button){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
            .child("following").child(firebaseUser.getUid());
