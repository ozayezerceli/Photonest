...
public class UserListAdapter extends ArrayAdapter<User> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final CircularImageView profileImage = convertView.findViewById(R.id.search_photo);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    GlideImageLoader.loadImageWithOutTransition(mContext, Objects.requireNonNull(ds.getValue(User.class)).getImageUrl(), profileImage);
                }
            }
            @Override
